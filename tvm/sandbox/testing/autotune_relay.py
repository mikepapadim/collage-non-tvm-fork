...
from tvm.relay.transform.pattern_manager.target import OPT_LEVEL, XEON_BUILD_TARGET
...
if __name__ == "__main__":
    ...
    from tvm.relay.transform.pattern_manager.target import get_build_target

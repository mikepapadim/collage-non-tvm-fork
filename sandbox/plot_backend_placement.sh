...
#CUDA_VISIBLE_DEVICES=0 python3 testing/plot_backend_placement.py -n resnext50_32x4d -hw v100
#CUDA_VISIBLE_DEVICES=0 python3 testing/plot_backend_placement.py -n nasneta -hw v100
CUDA_VISIBLE_DEVICES=0 python3 testing/plot_backend_placement.py -n bert_full -hw v100
#CUDA_VISIBLE_DEVICES=0 python3 testing/plot_backend_placement.py -n resnet50_3d -hw v100
#CUDA_VISIBLE_DEVICES=0 python3 testing/plot_backend_placement.py -n dcgan -hw v100
...
#CUDA_VISIBLE_DEVICES=1 python3 testing/plot_backend_placement.py -n bert_full -hw rtx2070

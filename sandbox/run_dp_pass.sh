...
#CUDA_VISIBLE_DEVICES=0 python3 testing/test_relay_build.py -n resnet50
#CUDA_VISIBLE_DEVICES=0 python3 testing/test_relay_build.py -n resnext50_32x4d
#CUDA_VISIBLE_DEVICES=0 python3 testing/test_relay_build.py -n nasneta
#CUDA_VISIBLE_DEVICES=0 python3 testing/test_relay_build.py -n nasrnn
#CUDA_VISIBLE_DEVICES=0 python3 testing/test_relay_build.py -n bert
